   	 ...
   	 <div class="col-md-12 profile_left">
   	 	...
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<div class="">
					<?php
					$targetImageUrl=$this->Html->url(array('controller'=>'../img','action'=>'member',$value['Viewprofile']['photo']));
					$photoImageUrl=$this->Html->url(array('controller'=>'../img','action'=>'member_thumb',$value['Viewprofile']['photo']));
			...
			<div class="col-sm-8 row_1">
				...
				<tr class="opened_1">
							...
							//if($value['Viewprofile']['name']){ echo$value['Viewprofile']['name'];}else{echo __('Not Specified');}?>
							</td>
						</tr>
						<tr class="opened_1" >
