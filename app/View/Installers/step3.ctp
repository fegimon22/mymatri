	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-footer">
				<div class="row">					
					<div class="col-md-12 text-center">Visit our website <?php echo$this->Html->link('http://silversyclops.net','http://silversyclops.net',array('target'=>'_blank'));?> for documentation and support</div>
			</div>
		</div>
	</div>
  </body>
