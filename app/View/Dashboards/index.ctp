<section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h3 title="<?php echo __('Dashboard');?>">
...
<?php 
 ...
 if($value['Dashboard']['photo_status'] == "Pending"){
 unset($value);
 }
...
<div class="grid_3">
  <div class="container">
   ...
   <?php 
   if(isset($this->params['named']['params']) && strlen($this->params['named']['params'])>0)
   {
   if($profilePercent!=100 && $this->params['named']['params']=='login'){?>
   <div class="alert alert-warning">
<button type="button" class="close" data-dismiss="alert">x</button>
<center><?php echo __('Please Complete Your Profile For Better Matching.');?></center>
</div>
   <?php }}?>
   <div class="about">
	  ...
	  <div class="progress">
	    <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo$profilePercent;?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo$profilePercent;?>%;"><?php echo __($profilePercent.'%');?></div>
	  </div>
