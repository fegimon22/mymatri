...
<div class="form-group">
    ...
    <div class="col-sm-4">
       <?php $manglik = array('Yes' => __('Yes'), 'No' => __('No'), 'Does not matter' => __('Does not matter'));
        echo $this->Form->select('manglik', $manglik, array('class' => 'form-control', 'empty' => __('Select'))); ?>
   </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
       <?php $children = array('Yes' => __('Yes'), 'No' => __('No'), 'Does not matter' => __('Does not matter'));
        echo $this->Form->select('children', $children, array('class' => 'form-control', 'empty' => __('Select'))); ?>
   </div>
