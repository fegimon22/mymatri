...
?>
<div id="resultDiv"> 
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Family Status');?></h1></div></div>
<div class="panel">
<?php echo $this->Session->flash();?>
    <div class="panel-heading">
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Familystatuses')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Family Status'),array('controller'=>'Familystatuses','action'=>'add'),array('escape'=>false,'escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Form->create(array('name'=>'deleteallfrm','action' => 'deleteall'));?>    
	...
	<div class="table-responsive">
		...
		<?php foreach ($Familystatus as $post):
		$id=$post['Familystatus']['id'];?>
		<tr>
		    <td><?php echo $this->Form->checkbox(false,array('value' => $post['Familystatus']['id'],'name'=>'data[Familystatus][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
		    <td><?php echo $serialNo++; ?></td>
		    <td><?php echo h($post['Familystatus']['name']); ?></td>
