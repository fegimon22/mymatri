...
<?php }?>
	...
	<div class="footer-text">&copy; <?php echo$this->Time->format('Y',$siteTimezone);?> <?php echo$siteName;?> <?php echo __('Powered by');?> <?php echo$this->Html->Link('Foodtrend Media Pvt Ltd.','http://www.foodtrend.media',array('target'=>'_blank'));?></div>
