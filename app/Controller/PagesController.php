 ...
 */
    ...
    $this->set('religionName',$this->Religion->find('list',array('joins'=>array(array('table'=>'members','alias'=>'Member','type'=>'INNER','conditions'=>array('Member.religion_id=Religion.id'))),'group'=>array('Religion.name'))));
	$this->set('mothertongueName',$this->Mothertongue->find('list',array('joins'=>array(array('table'=>'members','alias'=>'Member','type'=>'INNER','conditions'=>array('Member.mothertongue_id=Mothertongue.id'))),
