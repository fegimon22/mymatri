<script type="text/javascript">
    $(document).ready(function(){        
        $('#dob').datetimepicker({locale:'en',format:'YYYY-MM-DD'});
});
</script>
<!--================Slider Reg Area =================-->
 ...
 <?php echo $this->Form->create('Register', array( 'controller' => 'Register', 'action' => 'index','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal','role'=>'form','type' => 'file'));?>
            <div class="advanced_register home_registration">

                <div class="container">
                    <div class="register_inner"> <h3><?php echo __('Registration');?></h3>
                        <div class="search_item">
                            <h5><?php echo __('Profile Created By');?></h5>
					...
					echo $this->Form->select('profile_created',$profileCreated,array('class'=>'selectpicker','empty'=>__('Select')));   ?>
</div>
                        <div class="search_item">
                            <h5><?php echo __('Name');?></h5>
                            <?php echo $this->Form->input('name',array('label' => false,'class'=>'inputpicker','placeholder'=>__('Name'),'div'=>false));?>
                        </div>

                        <div class="search_item">
                            <h5><?php echo __('User Name');?></h5>
                            <?php echo $this->Form->input('user_name',array('required'=>true,'label' => false,'class'=>'inputpicker','placeholder'=>__('User Name'),'div'=>false));?>
                        </div>

                        <div class="search_item">
                            <h5><?php echo __('Date of Birth');?></h5>
                            <div class="input-group date" id="dob">
				       <?php echo $this->Form->input('dob',array('type'=>'text','value'=>$dob,'label' => false,'class'=>'inputpicker','div'=>false));?>
                    ...
                    <div class="search_item">
                            ...
                            <?php $url = $this->Html->url(array('controller'=>'Ajaxcontents','action' => 'caste'));
                              echo $this->Form->select('religion_id',$religionName,array('id'=>'religionId','rel'=>$url,'empty'=>__('Select'),'class'=>'selectpicker')); ?>
                        </div>

                        <div class="search_item">
                            <h5><?php echo __('Mother Tongue');?></h5>
                            <?php  echo $this->Form->select('mothertongue_id',$mothertongueName,array('class'=>'selectpicker','empty'=>__('Select')));   ?></div>
                        

                        <div class="search_item">
                            <h5><?php echo __('Mobile Number ');?></h5>
                            <?php echo $this->Form->input('phone',array('label' => false,'class'=>'inputpicker','placeholder'=>__('Phone'),'div'=>false));?>
                        </div>

                        <div class="search_item">
                            <h5><?php echo __('Email ID');?></h5>
                            <?php echo $this->Form->input('email',array('label' => false,'class'=>'inputpicker','placeholder'=>__('Email'),'div'=>false));?>
                        </div>

                        <div class="search_item">
                            <h5><?php echo __('Password');?></h5>
                            <?php echo $this->Form->input('password',array('label' => false,'class'=>'inputpicker','placeholder'=>__('Password'),'minlength'=>'4','maxlength'=>'15','div'=>false));?>
                        </div>

                        <div class="search_item">
                            <center><button type="submit" value="LogIn" class="btn form-control login_btn"><?php echo __('Register Free');?></button></center>
                        </div>
...
<?php echo $this->Form->create('Viewprofile', array( 'controller' => 'Viewprofiles', 'action' => 'index'));?>
	...
	?>
		    ...
		    <?php echo$this->Html->image($memberImg,array('class'=>'img-responsive imageblur','alt' =>$value['Member']['name']),array('escape' => false));?>
