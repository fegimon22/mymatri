...
<div class="col-md-3 left_side">
	  ...
	  <aside class="s_widget categories_widget" >
		  ...
		  <ul>
			...
			<li><?php echo$this->Html->link('<span class="fa fa-edit"></span>&nbsp;'.__("Basic Profile"),'javascript:void(0);',array('onclick'=>"show_modal('$urlProfile/editProfile');",'escape' => false));?></li>
