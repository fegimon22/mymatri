	    ...
	    <div class="col-sm-9" style="background:white;">
	    	<table class="table_working_hours table table-bordered" style="background-color:white;">
				...
				<tr class="opened">
						...
						<td class="day_value"><h5>&nbsp;<?php if($value['Viewprofile']['name']){ echo$value['Viewprofile']['name'];}else{echo __('Not Specified');}?></h5></td>
					</tr>
					...
					<tr class="opened">
						...
						<td class="day_value"><h5>&nbsp;<?php if($value['Viewprofile']['city_id']){echo$value['City']['name'];}else{echo __('Not Specified');}?>,&nbsp;<?php if($value['State']['name']){echo$value['State']['name'];}else{echo __('Not Specified');}?>,&nbsp;<?php if($value['Country']['name']){echo$value['Country']['name'];}else{echo __('Not Specified');}?></h5></td>
					</tr>
					<tr class="opened">
